...
urlpatterns = [
    ...
    path('me/gis/api/layers/<int:pk>/columns/', api.gis_layer_columns, name='api_gis_layer_columns'),
    path('me/gis/api/layers/<int:pk>/columns/<str:db>/',
    ...
    path('me/gis/api/layers/<int:pk>/summary/', api.gis_layer_summary, name='api_gis_layer_summary'),
    path('me/gis/api/dashboards/', api.gis_dashboards_collection, name='api_gis_dashboards'),
    path('me/gis/api/dashboards/send/', api.gis_dashboard_send, name='api_gis_dashboard_send'),
    path('me/gis/api/dashboards/<int:pk>/', api.gis_dashboard_detail, name='api_gis_dashboard_detail'),
