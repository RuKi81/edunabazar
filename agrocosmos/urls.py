...
urlpatterns = [
    ...
    path('report/region-detailed/', views.report_region_detailed, name='report_region_detailed'),
    path('report/unused/', views.report_unused, name='report_unused'),
    path('label/', views.label_dashboard, name='label_dashboard'),
    ...
    path('api/report/region-detailed/', views.api_report_region_detailed, name='api_report_region_detailed'),
