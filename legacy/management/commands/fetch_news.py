...
AGRO_KEYWORDS = [
    ...
    'комбайн', 'трактор', 'техник', 'посев', 'уборк', 'уборочн',
...
def _is_agro(title: str, summary: str) -> bool:
    """Check if the article is about agriculture/food."""
...
Сделай уникальный заголовок (до 100 символов) и краткий текст (2-3 предложения, до 300 символов).
Не копируй текст дословно. Сохрани факты и смысл. Пиши в информационном стиле.
